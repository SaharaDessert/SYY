...
var tr5 = new TableItems('神经',['中风','抽搐、癫痫','神经肌肉病变'],
[
    {
        //中风
        '发生时间':['&lt;2月','2月－1年','&gt;1年'],
        '类型':['脑梗死','脑出血'],
        '并存疾病':['无','高血压','风湿性心脏病','冠心病','颈、脑动脉粥样硬化、闭塞','其他'],
        '后遗症':['无','偏瘫','意识障碍','认知障碍','其他'],
    },
    {
        //抽搐、癫痫
        '发作频率':['极少','偶尔','有时','经常'],
    ...
    {
        //神经肌肉病变
        '分类':['小儿麻痹后遗症','脊髓损伤','格林－巴利(吉兰－巴雷)','进行性肌营养不良','多发性肌炎','周期性瘫痪','其他'],
        '是否肌无力':['是','否'],
        '是否痊愈':['是','否'],
    },
],
...
var tr6 = new TableItems('血液',['白血病','贫血'],
[
    {
        //白血病
        '分类':['急性','慢性'],
        '临床表现':['无','贫血','血小板减少','肺部感染','纵隔肿块','其他'],
        '是否痊愈':['是','否'],
    },
    {
        //贫血
        '严重程度(g/L)':['轻度(&gt;90)','中度(60-90)','重度(30-60)','极重度(&lt;30)'],
        '贫血原因':['缺铁性','巨幼细胞性','溶血性','再生障碍性','失血性','不清楚','其他'],
        '是否痊愈':['是','否'],
    },
],
{
...
var tr7 = new TableItems('内分泌、代谢',['糖尿病','甲亢','甲减','嗜铬细胞瘤','肾上腺肿瘤'],
[
    {
        //糖尿病
        '类型':['1型','2型'],
        '病程(年)':['1-5','5-10','&gt;10'],
        '并发症':['无','高血糖昏迷','酮症酸中毒','低血糖','高血压','冠心病','肾功能不全','胃瘫','颈椎关节强直综合征','视网膜病变','其他'],
        '治疗情况':['饮食控制','口服药物','胰岛素','未治疗'],
        '平素控制情况':['良好','一般','较差','不清楚'],
    },
    {
        //甲亢
        '病程(年)':['1-5','5-10','&gt;10'],
        '并发症':['无','甲状腺危象','甲状腺毒症心脏病(心动过速，心排血量增加，房颤，心衰)','眼病','胫前黏液性水肿','其他'],
        '治疗情况':['未治疗','抗甲状腺药物','放射碘/131I','手术治疗'],
        '甲功':['正常','异常'],
        '治疗后并发症':['粒细胞缺乏症','中毒性肝病','甲减','甲状旁腺功能减退','喉返神经损伤'],
    },
    {
        //甲减
        '病程(年)':['1-5','5-10','&gt;10'],
    ...
    },
    {
        ...
        '血儿茶酚胺及其代谢产物水平':['正常','异常'],
        '尿儿茶酚胺及其代谢产物水平':['正常','异常'],
        '术前酚苄明使用情况':['未使用','&lt;1周','1-2周','&gt;2周'],
        '是否术前扩容':['是','否','甲减'],
        '术前血压(mmHg)':['&lt;140/90','140/90-160/100','&gt;160/100'],
    },
    {
        //肾上腺肿瘤
        '类型':['原发性醛固酮增多症','皮质醇增多症（库欣综合征）','其他'],
        '大小cm':['？？？','不清楚'],
        '临床表现':['高血压','低钾血症','左心室肥大','心力衰竭','脑卒中','糖尿病','肾功能不全','其他'],
        '术前血压(mmHg)':['&lt;140/90','140/90-160/100','&gt;160/100'],
        '术前高血压、血糖、电解质异常是否纠正':['是','否'],
    },
],
{
    //多选三级字段
...
//每一行对象的列表
let itemsclasslist = [tr1,tr2,tr3,tr4,tr5,tr6,tr7];
